...
public class ClaseDeMusculacion extends Clase {

	private Integer codigo;

	public ClaseDeMusculacion(Integer codigo, Double precio, String nombre) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ClaseDeMusculacion other = (ClaseDeMusculacion) obj;
		if (codigo == null) {
